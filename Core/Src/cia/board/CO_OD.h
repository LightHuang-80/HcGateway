...
*******************************************************************************/
   ...
   #define CO_NO_RPDO                     (3*6)   //Associated objects: 1400, 1401, 1402, 1403, 1600, 1601, 1602, 1603
...
/*******************************************************************************
   OBJECT DICTIONARY
*******************************************************************************/
   #define CO_OD_NoOfElements             (57 + 1 + 6 + 4)
...
/*1016      */ UNSIGNED32     consumerHeartbeatTime[6];
...
/*C120		*/ OD_profile_t	  ds402Profile;
...
/*1016, Data Type: UNSIGNED32, Array[6] */
      #define OD_consumerHeartbeatTime                   CO_OD_ROM.consumerHeartbeatTime
      #define ODL_consumerHeartbeatTime_arrayLength      6
