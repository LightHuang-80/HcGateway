...
#define CO_CONFIG_TPDO_CALLS_EXTENSION 0 //0x04
...
#define CO_CONFIG_GTW_ASCII 0x00 //0x02
#define CO_CONFIG_GTW_ASCII_ERROR_DESC 0x00 //0x04
#define CO_CONFIG_GTW_ASCII_PRINT_HELP 0x00 //0x08
