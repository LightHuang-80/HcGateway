...
typedef enum {
	...
	/*Re define the host TPDO&RPDO default cobid*/
    CO_CAN_ID_RPDO_1 = 0x180,      /**< 0x200, Default RPDO1 (+nodeID) */
    CO_CAN_ID_TPDO_1 = 0x200,      /**< 0x180, Default TPDO1 (+nodeID) */
    CO_CAN_ID_RPDO_2 = 0x280,      /**< 0x300, Default RPDO2 (+nodeID) */
    CO_CAN_ID_TPDO_2 = 0x300,      /**< 0x280, Default TPDO2 (+nodeID) */
    CO_CAN_ID_RPDO_3 = 0x380,      /**< 0x400, Default RPDO3 (+nodeID) */
    CO_CAN_ID_TPDO_3 = 0x400,      /**< 0x380, Default TPDO3 (+nodeID) */
    CO_CAN_ID_RPDO_4 = 0x480,      /**< 0x500, Default RPDO5 (+nodeID) */
    CO_CAN_ID_TPDO_4 = 0x500,      /**< 0x480, Default TPDO4 (+nodeID) */
